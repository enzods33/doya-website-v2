-- Appliquer auto la promo tee (ex. 2TEES) si aucun code saisi et panier éligible.
...
comment on column public.promo_codes.auto_apply is
  'Si true, appliqué automatiquement quand le panier remplit min_tee_qty (sans code saisi).';

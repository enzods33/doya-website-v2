...
export default {
  ...
  admin: {
    ...
    photosLead: 'Edit the bio text (per language) and manage gallery photos.',
    ...
    salesTitle: 'Sales',
    salesLead: 'Orders, shipping and workshop stock.',
    ...
    salesStockTitle: 'Workshop stock',
    salesStockLead: 'Real quantities by size. The site shows stock minus in-checkout holds.',
    salesStockSave: 'Save stock',
    salesStockSaved: 'Stock updated.',
    salesStockEmpty: 'No catalog variants.',

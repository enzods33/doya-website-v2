...
export default {
  ...
  shop: {
    ...
    stripeNote: 'Secure payment via Stripe. Promo codes are confirmed at checkout.',
    viewCart: 'View cart',
  ...
  order: {
    ...
    thanks: 'Thank you.',
    receiptNote: 'A Stripe receipt is sent to {email}. Payment is only confirmed after validation.',
    total: 'Total',

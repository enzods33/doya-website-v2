...
export default {
  ...
  shop: {
    ...
    stripeNote: 'Pago seguro con Stripe. Los códigos promo se confirman al pagar.',
  ...
  order: {
    ...
    thanks: 'Gracias.',
    receiptNote: 'Un recibo de Stripe se envía a {email}. El pago solo se confirma tras la validación.',
    total: 'Total',

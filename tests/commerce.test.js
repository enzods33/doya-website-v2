...
test('aucune clé secrète n’est embarquée dans le client', () => {
  ...
  assert.match(readFileSync(new URL('../supabase/migrations/20260903120000_init_commerce.sql', import.meta.url), 'utf8'), /enable row level security/)
  assert.match(readFileSync(new URL('../supabase/migrations/20260903120000_init_commerce.sql', import.meta.url), 'utf8'), /create_pending_order/)
})
